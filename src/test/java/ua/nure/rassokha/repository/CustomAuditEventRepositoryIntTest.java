package ua.nure.rassokha.repository;

import ua.nure.rassokha.ScalesProdApp;
import ua.nure.rassokha.config.Constants;
import ua.nure.rassokha.config.audit.AuditEventConverter;
import ua.nure.rassokha.domain.PersistentAuditEvent;
...
import static ua.nure.rassokha.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
